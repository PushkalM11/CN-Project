        ...
        if self._ack_waiter is not None:
            if isinstance(event, events.StreamDataReceived): 
                ...
                if not hasattr(self, 'frame_size'):
                    ...
                    # Check if buffer has enough data for a frame
                    # print("FRAME SIZE IS:", self.frame_size, "BUFFER LEN IS:", len(self.buffer))
                    ...
                    while len(self.buffer) >= self.frame_size:
                        ...
                        # Tried: [2, 1, 0], 
                        # Success: [0, 1, 2] : 1st frame
                        # Success: [1, 2, 0] : 2nd frame
                        # Success: [2, 0, 1] : 3rd frame
